...
使用方式:
  ...
  # 3. 記錄實際成交（手動輸入）
  python paper_trade.py log --ticker 0700 --action buy --price 380 --shares 100
...
from strategy.market import normalize_ticker, to_yahoo_symbol
...
def fetch_latest_prices(tickers):
    ...
    try:
        ...
        prices.update(read_prices(hk_symbols))
    except Exception as e:
