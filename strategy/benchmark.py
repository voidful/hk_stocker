...
支援：
1. 2800.HK (盈富基金 / Tracker Fund of Hong Kong) Buy-and-Hold
2. 等權持有策略池內所有股票
3. Excess Return 計算
"""
...
from strategy.market import DEFAULT_BENCHMARK, DEFAULT_BENCHMARK_LABEL, to_yahoo_symbol

warnings.filterwarnings('ignore')


def fetch_benchmark(ticker=DEFAULT_BENCHMARK, days=800, start_date=None, end_date=None):
    """
    下載 Benchmark 的每日收盤價。
    ...
    label = DEFAULT_BENCHMARK_LABEL if ticker == DEFAULT_BENCHMARK else symbol
    print(f"📈 下載 Benchmark: {label} ({range_label})...")
